...
class SwipeBetweenViewControllers: UINavigationController,UIPageViewControllerDelegate,UIPageViewControllerDataSource,UIScrollViewDelegate
{
    ...
    func setupSegmentButtons() {
        ...
        println("viewcontrollerArray = \(viewControllerArray)")
        var numControllers :Int = viewControllerArray.count

        if (buttonText.count == 0) {
            buttonText = ["Read","Write","Web"] //%%%buttontitle
        }
        ...
        for (var i = 0 ; i < numControllers; i++) {
            ...
            button.setTitleColor(UIColor(red: 103/255, green:148/255 , blue: 54/255, alpha: 1.0), forState:  UIControlState.Normal)
            button.titleLabel!.font = UIFont(name: "Montserrat-Bold",size: CGFloat(18))
            navigationView.addSubview(button)

            button.tag = i //%%% IMPORTANT: if you make your own custom buttons, you have to tag them appropriately
            button.backgroundColor = UIColor(red: 241/255, green: 255/255, blue: 250/255, alpha: 1.0) //%%% buttoncolors
    ...
    func setupSelector() {
        ...
        selectionBar.backgroundColor = UIColor(red: 165/255, green:190/255 , blue: 0/255, alpha: 1.0) //%%% sbcolor
